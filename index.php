...
<body><nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand" href="?page=">Carros</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="?page=Cadastrar-Carros">Cadastrar</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="?page=Listar-Carros">Listar</a>
        </li>
      </ul>
    </div>
  </div>
...
$page=@$_REQUEST['page'];
switch($page){
	case 'Cadastrar-Carros':
		include('Cadastrar-Carros.php');
		break;
	case 'Listar-Carros':
